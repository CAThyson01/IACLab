...
VL_ATTR_COLD void Vf1_fsm___024root__trace_init_sub__TOP__0(Vf1_fsm___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+2,"enclk", false,-1);
    ...
    tracep->declBit(c+3,"clk", false,-1);
    tracep->declBus(c+4,"data_out", false,-1, 7,0);
    tracep->declBus(c+5,"state", false,-1, 31,0);
    ...
    tracep->declBus(c+8,"count", false,-1, 15,0);
...
VL_ATTR_COLD void Vf1_fsm___024root__trace_full_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+2,(vlSelf->enclk));
    bufp->fullBit(oldp+3,(vlSelf->clk));
    bufp->fullCData(oldp+4,(vlSelf->data_out),8);
    bufp->fullIData(oldp+5,(vlSelf->f1_fsm__DOT__state),32);
    bufp->fullIData(oldp+6,((((((((((0U == vlSelf->f1_fsm__DOT__state) 
                                                    ...
                                                    ((4U 
                                                     ...
                                                     ((5U 
                                                      ...
                                                      ((6U 
                                                        ...
                                                        : 8U)))))))
                              : 0U)),32);
    bufp->fullBit(oldp+7,(vlSelf->f1_fsm__DOT__en));
    bufp->fullSData(oldp+8,(vlSelf->f1_fsm__DOT__clocktick__DOT__count),16);
    bufp->fullIData(oldp+9,(0x10U),32);
    bufp->fullSData(oldp+10,(0x2fU),16);
}
