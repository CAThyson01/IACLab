...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+12,"incr", false,-1, 7,0);
    ...
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBit(c+4,"ren", false,-1);
    tracep->declBit(c+3,"wen", false,-1);
    tracep->declBus(c+8,"wr_addr", false,-1, 8,0);
    tracep->declBus(c+10,"re_addr", false,-1, 8,0);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+9,(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count),8);
    bufp->fullSData(oldp+10,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count) 
                                        - (IData)(vlSelf->offset)))),9);
    bufp->fullIData(oldp+11,(8U),32);
    bufp->fullCData(oldp+12,(1U),8);
